  ...
  return (
    <nav className="bg-secondary border-gray-200">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <input
          className="bg-transparent border-[1px] border-fontColor rounded-md h-[40px] w-full max-w-[400px] text-fontColor placeholder:text-fontColor px-[12px] outline-none focus:bg-primary transition-colors"
          name="search"
          id="search"
          type="text"
          placeholder="Search"
